...
public class FareRuleSet implements Serializable {
  ...
  private Set<String> routeShortNames;
  ...
  public FareRuleSet(FareAttribute fareAttribute) {
    ...
    routeShortNames = new HashSet<String>();
  ...
  public void addRouteShortName(String routeShortName) {
    routeShortNames.add(routeShortName);
  }
  ...
  public boolean matches(Set<String> agencies, String startZone, String endZone,
      Set<String> zonesVisited, Set<FeedScopedId> routesVisited, Set<FeedScopedId> tripsVisited) {
